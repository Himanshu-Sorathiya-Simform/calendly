...
import { createBookingLink } from "../../app/actions/dashboardActions";
...
export default function CreateBookingLinkModal({ children }: CreateBookingLinkModalProps) {
	...
	return (
		<>
			{children ? (
				...
				<Button onClick={() => setIsOpen(true)}>Create Booking Link</Button>
			)}
			...
			<Modal isOpen={isOpen} onOpenChange={setIsOpen}>
				<div className="space-y-4">
					...
					<p className="text-subtle text-sm">
						Create a new template to allow guests to book time with you.
					</p>
